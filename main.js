...
window.addEventListener('load', function () {
  ...
  if (window.dotMatrixParams) {
    ...
    dotMatrixParams.noiseScale = 15.0;
    dotMatrixParams.noiseSpeed = 0.3;
    ...
    dotMatrixParams.noiseGain = 0.044;
    dotMatrixParams.noiseThreshold = 0.9991;
    dotMatrixParams.noiseIslandSize = 1.3965;
    dotMatrixParams.noiseExposure = 0.402;
    dotMatrixParams.noiseGamma = 0.0532;
    dotMatrixParams.noiseMultiplier = 0.598;
    ...
    dotMatrixParams.influence1EdgeStart = 0.5;
    dotMatrixParams.influence1EdgeInfluence = 1.0;
    dotMatrixParams.influence1EdgeScale = 40.0;
    dotMatrixParams.influence1EdgeSpeed = 3.0;
    dotMatrixParams.influence1EdgeOctaves = 2;
    dotMatrixParams.influence1EdgeLacunarity = 2.5;
    dotMatrixParams.influence1EdgeGain = 0.877;
    dotMatrixParams.influence1EdgeThreshold = 0.9992;
    dotMatrixParams.influence1EdgeIslandSize = 0.2352;
